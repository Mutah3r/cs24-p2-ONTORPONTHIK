    ...
    const handleAddNewEmployee = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .post(
                        `https://cs24-p2-ontorponthik.onrender.com/thirdparties/addnewemployee`,
                        {
                            ...
                            payment_rate_per_hour:
                                result.value.payment_rate_per_hour,
                            contact_information:
                                result.value.contact_information,
                            assigned_collection_route:
                                result.value.assigned_collection_route,
                        }
                    )
                    .then((res) => {
                        setIsLoading(false);
