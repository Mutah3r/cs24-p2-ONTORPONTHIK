...
const ManageThirdParty = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                "https://cs24-p2-ontorponthik.onrender.com/thirdparties/allthirdparties"
            )
            .then((res) => {
    ...
    useEffect(() => {
        axios
            .get(
                "https://cs24-p2-ontorponthik.onrender.com/thirdparties/allcompany"
            )
            .then((res) => {
        ...
        Swal.fire({
          ...
          `,
            ...
            preConfirm: () => {
                ...
                const workforce_size =
                    document.getElementById("workforce-size").value;
                ...
                const designated_sts =
                    document.getElementById("designated-sts").value;
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .post(
                        "https://cs24-p2-ontorponthik.onrender.com/thirdparties/thirdparty",
                        {
                            ...
                            workforce_size: parseInt(
                                result.value.workforce_size
                            ),
                            ...
                            designated_sts: parseInt(
                                result.value.designated_sts
                            ),
                        }
                    )
                    .then((res) => {
    ...
    const handleAddContractorManager = () => {
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                const assigned_contractor_company = getObjectIdByCompanyName(
                    document.getElementById("assigned-contractor-company").value
                );
                const access_level =
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .post(
                        "https://cs24-p2-ontorponthik.onrender.com/thirdparties/addnewmanager",
                        {
                                ...
                                thirdParties.map((party, idx) => {
                                    return (
                                        <tr key={idx}>
                                            ...
                                            <td>
                                                {
                                                    party.payment_per_tonnage_of_waste
                                                }
                                            </td>
                                            <td>
                                                {
                                                    party.required_amount_of_waste_per_day
                                                }
                                            </td>
