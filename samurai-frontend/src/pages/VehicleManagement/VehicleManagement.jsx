...
const VehicleManagement = () => {
    ...
    useEffect(() => {
        axios
            .get("https://cs24-p2-ontorponthik.onrender.com/vehicle/allvehicle")
            .then((res) => {
    ...
    const handleAddVehicle = () => {
      ...
      `,
            ...
            preConfirm: () => {
                ...
                const capacity =
                    type == "Open Truck"
                        ...
                        ? "15"
                        : "";
                const fuelCostLoaded =
                    document.getElementById("fuelCostLoaded").value;
            ...
            didOpen: () => {
                ...
                const fuelCostLoadedInput =
                    document.getElementById("fuelCostLoaded");
                const fuelCostUnloadedInput =
                    document.getElementById("fuelCostUnloaded");
                fuelCostLoadedInput.addEventListener(
                    "input",
                    restrictToNumeric
                );
                fuelCostUnloadedInput.addEventListener(
                    "input",
                    restrictToNumeric
                );
            },
            willClose: () => {
                ...
                const fuelCostUnloadedInput =
                    document.getElementById("fuelCostUnloaded");
                fuelCostLoadedInput.removeEventListener(
                    "input",
                    restrictToNumeric
                );
                fuelCostUnloadedInput.removeEventListener(
                    "input",
                    restrictToNumeric
                );
            },
            ...
            if (result.isConfirmed) {
                ...
                axios
                    .post(
                        "https://cs24-p2-ontorponthik.onrender.com/vehicle/vehicleCreate",
                        {
                            ...
                            fuel_cost_per_km_loaded: parseFloat(
                                result.value.fuelCostLoaded
                            ),
                                ...
                                {vehicles &&
                                    vehicles.map((vehicle, idx) => (
                                        <tr key={vehicle._id}>
                                            ...
                                            <td>
                                                {vehicle.fuel_cost_per_km_loaded +
                                                    " BDT"}
                                            </td>
                                            <td>
                                                {vehicle.fuel_cost_per_km_unloaded +
                                                    " BDT"}
                                            </td>
                                        </tr>
                                    ))}
