...
const Profile = () => {
    ...
    useEffect(() => {
        axios
            .get(
                `https://cs24-p2-ontorponthik.onrender.com/profile?token=${userToken}`
            )
            .then((response) => {
                setUserData({
    ...
    const logoutUser = () => {
        axios
            .post("https://cs24-p2-ontorponthik.onrender.com/auth/logout", {
      ...
      `,
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    axios
                        .post(
                            "https://cs24-p2-ontorponthik.onrender.com/auth/change-password",
                            {
                ...
                axios
                    ...
                    .then((res) => {
                        if (res.data.role) {
                            axios
                                .put(
                                    "https://cs24-p2-ontorponthik.onrender.com/profile",
                                    {
                                        name: result.value,
