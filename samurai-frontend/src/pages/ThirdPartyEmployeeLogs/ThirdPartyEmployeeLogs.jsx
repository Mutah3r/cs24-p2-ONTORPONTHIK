...
const ThirdPartyEmployeeLogs = () => {
  ...
  const handleLogEntry = (event) => {
    ...
    axios
      .post("http://localhost:8000/thirdparties/createemployeelog", {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      >
        <div className="mb-4">
          <label className="block mb-1 text-gray-700">Employee Name:</label>
          <select
            id="employee"
            name="employee"
        ...
        <div className="mb-4">
          <label className="block mb-1 text-gray-700">Login Time:</label>
          <input
            type="datetime-local"
            name="loginTime"
        ...
        <div className="mb-4">
          <label className="block mb-1 text-gray-700">Logout Time:</label>
          <input
            type="datetime-local"
            name="logoutTime"
            className="input input-bordered w-full"
